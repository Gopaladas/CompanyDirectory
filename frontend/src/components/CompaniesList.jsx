...
const CompaniesList = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-50 min-h-screen">
      ...
      <div
        className={`${
          isMobile ? (showCompanyList ? "block" : "hidden") : "w-full md:w-1/3"
          ...
          <div className="flex space-x-3 mb-3">
            <div className="relative flex-1">
              <input
                ...
                className="w-full pl-9 pr-10 py-2 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm md:text-base"
              />
              <svg
            ...
            <button
              ...
              className="px-3 md:px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center space-x-2 flex-shrink-0"
            >
              <svg
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center mt-2">
                      <svg
                        className="w-3 h-3 md:w-4 md:h-4 text-gray-400 mr-1"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
            ...
            <div className="p-6 md:p-8 text-center">
              ...
              {(searchTerm ||
                ...
                <button
                  ...
                  className="mt-3 px-3 py-1 md:px-4 md:py-2 text-xs md:text-sm font-semibold text-blue-600 hover:text-blue-700"
                >
                  Clear all filters
                </button>
              )}
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex justify-between items-center">
              <button
                ...
                className="px-3 py-1 md:px-4 md:py-2 text-xs md:text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Previous
              </button>
      ...
      <div
        className={`${
          isMobile ? (showCompanyList ? "hidden" : "block") : "flex-1"
        } p-4 md:p-8`}
      >
        {selectedCompany ? (
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between">
                <div className="flex items-start space-x-3 md:space-x-4 mb-4 md:mb-0">
                ...
                <div className="flex space-x-2">
                  <button className="px-4 py-2 text-sm md:text-base bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-colors">
                    Visit website
                  </button>
                </div>
              </div>
                  ...
                  .map((company) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-gray-400 to-gray-500 rounded-lg flex items-center justify-center">
